		...
		<?php if (plogger_picture_allows_comments()) {
			...
			<form action="<?php echo $config['gallery_url']; ?>plog-comment.php" method="post" id="commentform">
				<p>
					...
					<span><label for="author"><?php echo plog_tr('Name'); ?></label> (<?php echo plog_tr('required'); ?>)</span>
				...
				<p>
					...
					<span><label for="email"><?php echo plog_tr('Email'); ?></label> (<?php echo plog_tr('required, but not publicly displayed'); ?>)
				</p>
				<p>
					...
					<span><label for="url"><?php echo plog_tr('Your Website (optional)'); ?></label>
				</p>
				<p>
					<span><label for="comment"><?php echo plog_tr('Your Comment'); ?></label></span><br />
