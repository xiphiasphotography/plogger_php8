...
// Fill $revision with latest changeset number from SVN
$revision = '$LastChangedRevision$'; // This string is automatically changed by SVN version control
$revision = substr($revision, strpos($revision, ' ')+1, strrpos($revision, ' ')-strpos($revision, ' ')-1);

$config['version'] = 'VERSION: 1.0-PDO-Rev'.$revision;
