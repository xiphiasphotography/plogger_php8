...
$init_vars = array('db_user', 'db_pass', 'db_name', 'db_type', 'db_port', 'gallery_name', 'admin_username', 'admin_email', 'ftp_user', 'ftp_pass', 'ftp_path');
...
<?php if (!defined('PLOGGER_DB_HOST')) { ?>
		...
		<tr>
			<td class="form_label"><label for="db_type"><?= plog_tr('Database Type') ?>:</label></td>
			<td class="form_input">
				<select name="db_type" id="db_type">
					<option value="mysql" <?php if($form['db_type'] == 'mysql'){echo 'selected';} ?>>MySQL</option>
					<option value="pgsql" <?php if($form['db_type'] == 'pgsql'){echo 'selected';} ?>>PostgreSQL</option>
				</select>
			</td>
		</tr>
		<tr>
			<td class="form_label"><label for="db_host"><?= plog_tr('Database Host') ?>:</label></td>
			<td class="form_input"><input type="text" name="db_host" id="db_host" value="<?= $form['db_host']; ?>" /></td>
		</tr>
		<tr>
			<td class="form_label"><label for="db_port"><?= plog_tr('Database Port (Optional, PgSQL only)') ?>:</label></td>
			<td class="form_input"><input type="text" name="db_port" id="db_port" value="<?= $form['db_port']; ?>" /></td>
		</tr>	
		<tr>
			<td class="form_label"><label for="db_user"><?= plog_tr('Database Username') ?>:</label></td>
			<td class="form_input"><input type="text" name="db_user" id="db_user" value="<?= $form['db_user']; ?>" /></td>
		</tr>
		<tr>
			<td class="form_label"><label for="db_pass"><?= plog_tr('Database Password') ?>:</label></td>
